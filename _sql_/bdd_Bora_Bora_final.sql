...
-- Listage de la structure de la table borabora. bar_concerne
CREATE TABLE IF NOT EXISTS `bar_concerne` (
...
-- Listage de la structure de la table borabora. bar_facture
CREATE TABLE IF NOT EXISTS `bar_facture` (
...
-- Listage de la structure de la table borabora. bar_sejour
CREATE TABLE IF NOT EXISTS `bar_sejour` (
  `Num_Cons` int(11) NOT NULL,
  `Num_Sej` int(11) NOT NULL,
  PRIMARY KEY (`Num_Cons`,`Num_Sej`),
  KEY `Num_Sej` (`Num_Sej`),
  KEY `Num_Cons` (`Num_Cons`),
  CONSTRAINT `FK_Sejour_Bar_facture_bar` FOREIGN KEY (`Num_Cons`) REFERENCES `bar_facture` (`Num_Conso_Bar`),
...
-- Listage de la structure de la table borabora. brasserie_cat
CREATE TABLE IF NOT EXISTS `brasserie_cat` (
...
-- Listage de la structure de la table borabora. brasserie_concerne
CREATE TABLE IF NOT EXISTS `brasserie_concerne` (
  ...
  CONSTRAINT `FK__facture_brasserie` FOREIGN KEY (`Num_Conso`) REFERENCES `brasserie_facture` (`Num_Conso_Brasserie`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Listage de la structure de la table borabora. brasserie_facture
CREATE TABLE IF NOT EXISTS `brasserie_facture` (
...
-- Listage de la structure de la table borabora. brasserie_sejour
CREATE TABLE IF NOT EXISTS `brasserie_sejour` (
  `Num_Conso` int(11) NOT NULL,
  `Num_Sej` int(3) NOT NULL,
  PRIMARY KEY (`Num_Conso`,`Num_Sej`),
  KEY `comprend_brasseriefk_1` (`Num_Sej`),
  KEY `Num_Conso` (`Num_Conso`),
  CONSTRAINT `comprend_brasseriefk_1` FOREIGN KEY (`Num_Conso`) REFERENCES `brasserie_facture` (`Num_Conso_Brasserie`),
...
-- Listage de la structure de la table borabora. brasserie_table
CREATE TABLE IF NOT EXISTS `brasserie_table` (
  `id_table` int(5) NOT NULL,
  `num_table` int(5) DEFAULT NULL,
  PRIMARY KEY (`id_table`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Listage des données de la table borabora.brasserie_table : ~0 rows (environ)
...
CREATE TABLE IF NOT EXISTS `chambre` (
  ...
  CONSTRAINT `FK_chambre_cate_chambre` FOREIGN KEY (`Categorie`) REFERENCES `chambre_cate` (`Id_Cat`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Listage de la structure de la table borabora. chambre_cate
CREATE TABLE IF NOT EXISTS `chambre_cate` (
...
-- Listage de la structure de la table borabora. chambre_sejour
CREATE TABLE IF NOT EXISTS `chambre_sejour` (
...
CREATE TABLE IF NOT EXISTS `consommation` (
  ...
  CONSTRAINT `consommation_ibfk_1` FOREIGN KEY (`cat`) REFERENCES `consommation_cat` (`cat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Listage de la structure de la table borabora. conso_categorie
CREATE TABLE IF NOT EXISTS `conso_categorie` (
  `cat` varchar(6) NOT NULL,
  `lib_cat` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`cat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Listage des données de la table borabora.facture : ~0 rows (environ)
...
-- Listage des données de la table borabora.sejour : ~0 rows (environ)
...
-- Listage des données de la table borabora.spa : ~0 rows (environ)
...
-- Listage de la structure de la table borabora. spa_categorie
CREATE TABLE IF NOT EXISTS `spa_categorie` (
...
-- Listage des données de la table borabora.spa_categorie : ~0 rows (environ)
...
-- Listage de la structure de la table borabora. spa_concerne
CREATE TABLE IF NOT EXISTS `spa_concerne` (
  ...
  CONSTRAINT `FK_comprend_spa_facture` FOREIGN KEY (`Num_FactSpa`) REFERENCES `spa_facture` (`NumFactureSpa`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Listage de la structure de la table borabora. spa_facture
CREATE TABLE IF NOT EXISTS `spa_facture` (
  `NumFactureSpa` int(11) NOT NULL,
  `Date_Spa` date NOT NULL,
  `Quantite_Spa` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`NumFactureSpa`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Listage de la structure de la table borabora. spa_sejour
CREATE TABLE IF NOT EXISTS `spa_sejour` (
  `NumFactSpa` int(11) NOT NULL,
  `Num_Sej` int(11) NOT NULL,
  PRIMARY KEY (`NumFactSpa`,`Num_Sej`),
  KEY `NumFactSpa` (`NumFactSpa`),
  KEY `Num_Sej` (`Num_Sej`),
  CONSTRAINT `FK__facture_spa` FOREIGN KEY (`NumFactSpa`) REFERENCES `spa_facture` (`NumFactureSpa`),
...
-- Listage de la structure de la table borabora. users
